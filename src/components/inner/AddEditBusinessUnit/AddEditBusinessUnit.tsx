...
import styles from './AddEditBusinessUnit.module.scss';
...
interface ModalProps {
    ...
    setCurrentRow: (currentRow:any) =>any;
    setIsNewBu: boolean
...
const AddEditBusinessUnit: React.FC<ModalProps> = ({ buOpen, onReqClose,
                                                       updateBusinessUnits,setCurrentRow,
                                                       selectedRowData ,refreshBusinessUnits,setIsNewBu}) => {
        ...
        fetchUnits().then((r) => {
            ...
            if (selectedRowData) {
                setUnitValues({
                    ...
                    businessUnitName: selectedRowData.businessUnitName
                });
            }
        });
    ...
    return (
        <Box className={styles.AddEditBusinessUnit}>
            <Modal
